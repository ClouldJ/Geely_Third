...
- (void)viewDidLoad {
    ...
    [button_volume_ addTarget:self action:@selector(volumeLes9) forControlEvents:UIControlEventTouchUpInside];
    ...
    [button_vo addTarget:self action:@selector(volumeAdd9) forControlEvents:UIControlEventTouchUpInside];
