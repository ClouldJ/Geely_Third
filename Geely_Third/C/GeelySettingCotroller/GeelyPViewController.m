...
- (void)viewDidLoad {
    ...
    [button_volume_ addTarget:self action:@selector(volumeLes2) forControlEvents:UIControlEventTouchUpInside];
    ...
    [button_vo addTarget:self action:@selector(volumeAdd2) forControlEvents:UIControlEventTouchUpInside];
