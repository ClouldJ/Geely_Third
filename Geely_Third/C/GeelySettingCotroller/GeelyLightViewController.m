...
//    WithImage:[UIImage imageNamed:@"12.3_ts_comfort_setting_energy_20161009_4_01"]
    ...
    [button_volume_ addTarget:self action:@selector(volumeLes3) forControlEvents:UIControlEventTouchUpInside];
    ...
    [button_vo addTarget:self action:@selector(volumeAdd3) forControlEvents:UIControlEventTouchUpInside];
