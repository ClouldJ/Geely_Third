...
- (void)viewDidLoad {
    ...
    [button_volume_ addTarget:self action:@selector(volumeLes7) forControlEvents:UIControlEventTouchUpInside];
    ...
    [button_vo addTarget:self action:@selector(volumeAdd7) forControlEvents:UIControlEventTouchUpInside];
