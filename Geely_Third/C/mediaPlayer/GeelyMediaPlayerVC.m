...
- (void)viewDidLoad {
    ...
    [button_volume_ addTarget:self action:@selector(volumeLes4) forControlEvents:UIControlEventTouchUpInside];
    ...
    [button_vo addTarget:self action:@selector(volumeAdd4) forControlEvents:UIControlEventTouchUpInside];
